...
func TestTools_CreateDirIfNotExist(t *testing.T) {
	const testDirPath = "./testdata/myDir"
	var testTools Tools

	err := testTools.CreateDirIfNotExist(testDirPath)
	if err != nil {
		t.Error(err)
	}
...
var slugTests = []struct {
	...
	{name: "empty string", s: "now is the time", expected: "", errorExpected: true},
	...
	{name: "japanese string", s: "今何時ですか", expected: "", errorExpected: true},
	{name: "japanese string and roman characters", s: "hello world, 今何時ですか", expected: "hello-world", errorExpected: false},
}
